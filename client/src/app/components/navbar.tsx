        ...
        <div>
            <nav className="bg-white border-gray-200 dark:bg-gray-900">
                <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
                    <span className="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">Educosys YouTube</span>
                    <div className="hidden w-full md:block md:w-auto" id="navbar-default">
                        {
                            data ? (
                                <div className='flex'>
                                    ...
                                    <div className='m-3'>
                                        <img className="w-10 h-10 rounded-full" src={data.user?.image ?? ""} alt="" />
                                    </div>
                                </div>
